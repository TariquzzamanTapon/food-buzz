...
const Footer = () => {
    return (
        <div className='p-1 sm:p-2 md:p-7 lg:p-10 bg-[#262626] '>
            ...
            <footer className="footer p-10 py-2 border-t text-white  border-base-300">
                <div className="items-center grid-flow-col">
                    ...
                    <p><span className="font-bold text-2xl">Food<span className='text-orange-400'>Buzz</span></span></p>
                </div>
